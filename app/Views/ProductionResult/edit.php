...
<div class="card">
    <div class="card-body">
        ...
        <form class="forms-sample" id="form" action="<?= base_url() ?>production/result/update" method="POST"
              autocomplete="off"
                ...
                <div class="form-group row mb-0 d-flex align-items-center" <?= $form['type'] === 'hidden' ? 'hidden' : '' ?> >
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php elseif ($form['type'] == 'file'): ?>
                            <div class="d-block" >
                                <img id="<?= $form['id'] ?>-image" style="height: 200px" src="<?= $form['src'] ?>" class="p-2" alt="#">
                                <?= form_input($form) ?>
                            </div>
                        <?php else: ?>
                            <?= form_input($form) ?>
